...
> **[v1.1.0](https://github.com/dylanpdx/dylan-morphepatches/releases/tag/v1.1.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;3 patches total
<details open>
...
| 💊&nbsp;Patch | 📜&nbsp;Description | ⚙️&nbsp;Options |
|----------|----------------|-----------|
| [Disable IAP](#disable-iap) | Disables inapp purchases by preventing connection to billing client |  |
| [Spoof network country](#spoof-network-country) | Spoofs the country code returned by TelephonyManager | • Country code |
